...
export interface ApiFirstLevelStructureFirstLevelStructure
  ...
  info: {
    displayName: 'first_level_structure';
    pluralName: 'first-level-structures';
    singularName: 'first-level-structure';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSecondLevelStructureSecondLevelStructure
  extends Struct.CollectionTypeSchema {
  collectionName: 'second_level_structures';
  info: {
    displayName: 'second_level_structure';
    pluralName: 'second-level-structures';
    singularName: 'second-level-structure';
  };
  options: {
    draftAndPublish: true;
  };
